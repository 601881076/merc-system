...
public class TWithholdAgreeExcel extends BaseRowModel {
     ...
     * 银行名称
     */
    @ExcelProperty(value = "银行名称", index = 5)
     ...
     * 协议编号
     */
    @ExcelProperty(value = "缴费编号", index = 1)
     ...
     * 短信验证码
     */
    @ExcelProperty(value = "短信验证码", index = 9)
     ...
     */
    @ExcelProperty(value = "授权结果", index = 2)
    ...
    @ExcelProperty(value = "授权金额(元)", index = 13)
    private BigDecimal singleMax;

    @ExcelProperty(value = "当天累计(元)", index = 14)
    private BigDecimal dayMax;

    @ExcelProperty(value = "当月累计(元)", index = 15)
    private BigDecimal monthMax;

    @ExcelProperty(value = "累计限额(元)", index = 16)
