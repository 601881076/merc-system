...
public class PoundageServiceImpl implements PoundageService {
    ...
    public void exportExcel(HttpServletResponse response, PoundageParam poundageParam) {
        ...
        try {
            ...
            Sheet sheet = new Sheet(1,0, FeeMoneyQuery.class);
            //设置自适应宽度
...
//            bf = BaseFont.createFont("STSong-Light", "UniGB-UCS2-H", BaseFont.NOT_EMBEDDED);
            // 本地调试字体路径 C:\Windows\Fonts\simsunb.ttf
            // 生产环境字体路径 C:\data\pdf\simsun.ttc
            bf = BaseFont.createFont("/fonts/simsun.ttc,1", BaseFont.IDENTITY_H, BaseFont.NOT_EMBEDDED);
